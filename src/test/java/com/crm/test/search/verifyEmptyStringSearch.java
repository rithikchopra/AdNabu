...
public class verifyEmptyStringSearch extends TestBase {
	...
	String TCDesc = "TC002_Automating Empty String Search";

	public verifyEmptyStringSearch() {
		super();
	}

	@Test(description = "TC002_Automating Empty String Search", priority = 1)
	public void LoginPageTest() throws AWTException {
		...
		.searchForText(" ")
		.verifySearchKeywordInProductsTitle(" ");
		driver.quit();
	}
